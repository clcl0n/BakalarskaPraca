...
public class CustomTrainData extends CustomData {

    public CustomTrainData(String fileDataPath, int inNeu, int outNeu) {
        super(fileDataPath, ";", inNeu, outNeu);
    }

    @Override
    void consResultData(String[] elements) {
        int size = this.outNeu;
